...
// ─── CLOB limit order ─────────────────────────────────────────────────────────
// Places a limit order on the CLOB at a specific price
// price is 0-1 (e.g. 0.45 = 45¢)

export async function placeLimitOrder(publicKey, secretKey, eventId, marketId, orderBody) {
  return signedRequest(publicKey, secretKey, "POST", `/v1/pm/events/${eventId}/markets/${marketId}/orders`, {
    ...orderBody,
    type: "LIMIT",
  });
}
